...
namespace Ykse.Partner
{
	public class Symbol
	{
		public static string[] All = new[]{
			Space, Zero, At, Asterisk, Ellipsis, Tilde, Percent,
		...
		public static readonly string Char1 = Convert.ToChar(1).ToString();
		...
		public static readonly string CommaNewLine =
		...
		public static class Char
		{
			...
			public static readonly char Char1 = Convert.ToChar(1);
